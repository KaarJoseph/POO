...
public class PoligonoVista {
    ...
    public void Crear(){
        ...
        boolean resultado=poligonoControlador.Crear(numLineas, 20, 400, figuraControlador.getSeleccionado());
        System.out.println("Creado = "+resultado);
    }
   
   
    public Poligono Buscar(){
        System.out.println("Ingrese el numero de lineas del poligono que desea buscar: ");
        int numLineas=teclado.nextInt();
    ...
    public void Actualizar(){
        System.out.println("Ingrese el numero de lineas que va a actualizar: ");
        int numLineas=teclado.nextInt();
    ...
    public void Eliminar(){
        System.out.println("Ingrese el numero de lineas de el poligono que desea eliminar");
        int numlineas=teclado.nextInt();
