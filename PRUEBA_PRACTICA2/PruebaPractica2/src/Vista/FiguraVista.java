...
public class FiguraVista {
    ...
    public Figura Buscar(){
        System.out.println("Ingrese el identificador de la figura que desea buscar: ");
        String identificador=teclado.next();
    ...
    public void Actualizar(){
        System.out.println("Ingrese el identificador de la figura que desea actualizar: ");
        String identificador=teclado.next();
    ...
    public void Eliminar(){
        System.out.println("Ingrese el identificador de la figura que desea eliminar: ");
        String identificador=teclado.next();
