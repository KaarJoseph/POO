...
public class LineaVista {
    ...
    public void Crear(){
        System.out.println("Ingrese el identificador de las líneas: ");
        String identificador=teclado.next();
        System.out.println("Ingrese el punto inicial del eje X: ");
        double P1X=teclado.nextDouble();
        System.out.println("Ingrese el punto final del eje X: ");
        double P2X=teclado.nextDouble();
        System.out.println("Ingrese el punto inicial del eje Y: ");
        double P1Y=teclado.nextDouble();
        System.out.println("Ingrese el punto final del eje Y: ");
    ...
    public Linea Buscar(){
        System.out.println("Ingrese el identificador de la linea que desea buscar: ");
        String identificador=teclado.next();
    ...
    public void Actualizar(){
        System.out.println("Ingrese el identificador de la linea que desea actualizar");
        String identificador=teclado.next();
        System.out.println("Ingrese el punto inicial del eje X: ");
        double P1X=teclado.nextDouble();
        System.out.println("Ingrese el punto final del eje X: ");
    ...
    public void Eliminar(){
        System.out.println("Ingrese el identificador de la linea que desea eliminar: ");
        String identificador=teclado.next();
