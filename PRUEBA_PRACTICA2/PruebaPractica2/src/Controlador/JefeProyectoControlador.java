...
public class JefeProyectoControlador {
    ...
    public boolean Crear(int codigo, String direccion, String nombre, String telefono){
        JefeProyecto persona=new JefeProyecto(this.generarID(), codigo, direccion, nombre, telefono);
        return listaPersonas.add(persona);
    }
    public boolean Crear(int codigo, String direccion, String nombre, String telefono,Proyecto proyecto){
    ...
    public boolean Actualizar(int codigo, String direccion, String nombre,String nombrenuevo, String telefono){
