...
public class FiguraControlador {
    ...
    public boolean Crear(String identificador, String nombre, String color){
        Figura figura=new Figura(this.generarID(), identificador, nombre, color);
        return listaFiguras.add(figura);
    }
    public boolean Crear(String identificador, String nombre, String color, Plano planos){
        Figura figuras=new Figura(this.generarID(), identificador, nombre, color, planos);
