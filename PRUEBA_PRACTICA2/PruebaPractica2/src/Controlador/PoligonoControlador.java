...
public class PoligonoControlador {
    ...
    public boolean Crear( int numLineas, double perimetro, double area){
        Poligono poligonos=new Poligono(this.generarId(), numLineas, perimetro, area);
        return listaPoligonos.add(poligonos);
    }
    public boolean Crear( int numLineas, double perimetro, double area,Figura figura){
        Poligono poligono = new Poligono(this.generarId(), numLineas, perimetro, area, figura);
